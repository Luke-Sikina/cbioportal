...
CREATE TABLE `study_view_filter_cache` (
  `FILTER_HASH` int(16) NOT NULL,
  `SAMPLE_INTERNAL_ID` int(11) NOT NULL,
  PRIMARY KEY (`FILTER_HASH`, `SAMPLE_ID`),
  FOREIGN KEY (`SAMPLE_INTERNAL_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
);
